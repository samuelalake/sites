...
export default function Nav() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 h-[56px] flex items-center justify-between px-4 bg-white/80 backdrop-blur-sm">
      {/* Logo */}
      ...
      <a
        href="#"
        className="bg-[#090b0c] text-[#fafafa] font-['displayFont:Medium','Plus_Jakarta_Sans',sans-serif] text-[14px] leading-[20px] px-[11px] py-[8px] rounded-full hover:opacity-90 transition-opacity"
      >
        Download
      </a>
    </nav>
